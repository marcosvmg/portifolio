...
const steps: TimelineItem[] = [
  ...
  },
  {
   ...
   {
    title: 'ViniVinil',
    description: 'Aplicação completa de front/backend para vendas de disco de vinil.',
    url: 'https://vinivinil.onrender.com/home',
    languages: ['Laravel', 'Tailwindcss', 'postgresql'],
    showcase: {
      desktop: { gifUrl: '/assets/img/projetos/vinivinil/vinivinildesktop.gif' }, // Exemplo de GIF de terminal/backend
