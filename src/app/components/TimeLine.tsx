...
const languageColors: Record<string, string> = {
  ...
  react: 'text-sky-500',
  'next.js': 'text-zinc-400', // A cor da marca é neutra (preto/branco)
...
const ProjectModal = ({
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onClose}
        className="absolute top-4 right-4 bg-white/20 text-white p-2 rounded-full z-10 hover:bg-white/40 transition-colors"
