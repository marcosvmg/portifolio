...
export default function Main() {
  return (
    <main className="flex flex-col gap-5 justify-center px-2 w-full max-w-full overflow-x-hidden">
      ...
      <div className="flex flex-col md:flex-row bg-c0 rounded-2xl px-4 py-6 md:px-10 md:py-10 gap-6 md:gap-0 w-full max-w-full overflow-x-hidden">
        ...
        {/* Divider - horizontal em mobile, vertical em desktop */}
        <div className="w-full h-2 md:w-2 md:h-[720px] rounded-2xl bg-[#54505A]/20 md:mx-8 min-w-0" />

        {/* Text Main - melhor espaçamento para mobile */}
        <div className="flex flex-col flex-1 justify-between bg-b noise-[128,50,5] rounded-2xl p-6 md:p-10 text-center md:text-right select-none min-w-0 w-full">
          ...
          <div className="self-center md:self-end mt-6 md:mt-auto">
            <Link
              href="#contato"
      ...
      {/* Seta para baixo - menor em mobile */}
      <div className="fixed left-4 bottom-4 z-50 text-c1">
        <svg
          width="48"
          height="48"
          viewBox="0 0 48 48"
      ...
      {/* knowledge - scroll horizontal em mobile */}
